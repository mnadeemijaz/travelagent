...
export default function VoucherView({ voucher, hotels, clients, ziarats, company }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4 max-w-5xl mx-auto">
                ...
                <div className="flex gap-2 mb-4 no-print">
                    <Link
                        href={route('admin.vouchers.invoice', voucher.id)}
                        className="px-3 py-1.5 bg-blue-600 text-white text-sm rounded hover:bg-blue-700"
                    >
                        View Invoice
                    </Link>
                    <a
                        href={route('admin.vouchers.pdf', voucher.id)}
                ...
                {/* Printable area */}
                <div id="voucher-print" className="relative bg-white border border-gray-300 p-4 print:border-0 print:p-0">
                    ...
                    <table className="w-full mb-2">
                        <tbody>
                            <tr>
                                ...
                                <td className="w-1/4 text-right align-bottom text-xs text-gray-600">
                                    Agent: {voucher.agent_name}
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            {hotels.length === 0 && (
                                <tr><Td className="text-center" children="—" />{/* colspan workaround */}</tr>
                            )}
                            {hotels.map((h, i) => (
                                <tr key={i}>
                                    <Td>{h.city_name}</Td>
            ...
            <style>{`
                @media print {
                    ...
                    #voucher-print { position: absolute; top: 0; left: 0; width: 100%; margin: 0; padding: 8px; border: none !important; }
